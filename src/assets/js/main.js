...
function ImgZoom() {console.log($('.ex1 img'));$('.ex1 img').elevateZoom({zoomType				: "lens",lensShape : "round",lensSize    : 200});}
...
/* ============================================= */
function moveNav(){console.log('======moveNav========')
  $("<div>", {"class": "owl-controls"}).append($('.owl-nav')).appendTo('.owl-carousel');
